        ...
        if (connect(clientSocket, (struct sockaddr *) &serverAddr,addr_size) < 0)
            ...
            while(*pointer != '\0'){
                ...
                if (strncmp("GET", line, 3) == 0)
                    ...
                    printf("Erorr, unsupported command !\n");
                pointer++; // move pointer past <CR> OR <LF>
                // skipe spaces
